...
module LlmCostTracker
  class Railtie < Rails::Railtie
    ...
    generators do
      ...
      require_relative "generators/llm_cost_tracker/upgrade_call_line_items_currency_index_generator"
      require_relative "generators/llm_cost_tracker/upgrade_provider_invoice_imports_finished_at_index_generator"
    end
