...
| --- | --- | --- |
| `llm_cost_tracker_call_rollups` | `llm_cost_tracker:call_rollups` + `config.cache_period_totals = true` | Pre-aggregated day/month totals per currency/provider for fast budget reads |
