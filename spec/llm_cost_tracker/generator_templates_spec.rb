...
RSpec.describe "generator templates" do
  ...
  it "provides a token usage upgrade migration" do
    ...
    expect(migration).not_to include("add_column :llm_cost_tracker_calls, :cache_read_input_cost")
    expect(migration).not_to include("add_column :llm_cost_tracker_calls, :audio_output_cost")
